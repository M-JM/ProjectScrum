...
namespace MielsJimmyScrumProjectDAL.Migrations
{
    ...
    [Migration("20200411210625_Alt2ManytoManyRelationBetweenBoardandUsers")]
    partial class Alt2ManytoManyRelationBetweenBoardandUsers
    {
            ...
            modelBuilder.Entity("MielsJimmyScrumProjectDAL.Models.BoardUser", b =>
                {
                    b.HasOne("MielsJimmyScrumProjectDAL.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("BoardUser")
                        .HasForeignKey("MielsJimmyScrumProjectDAL.Models.BoardUser", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
