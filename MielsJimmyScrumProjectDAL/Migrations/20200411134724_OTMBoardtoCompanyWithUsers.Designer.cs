...
namespace MielsJimmyScrumProjectDAL.Migrations
{
    ...
    [Migration("20200411134724_OTMBoardtoCompanyWithUsers")]
    partial class OTMBoardtoCompanyWithUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MielsJimmyScrumProjectDAL.Models.TaskStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MielsJimmyScrumProjectDAL.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MielsJimmyScrumProjectDAL.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MielsJimmyScrumProjectDAL.Models.BoardTask", b =>
                {
                    ...
                    b.HasOne("MielsJimmyScrumProjectDAL.Models.TaskStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("MielsJimmyScrumProjectDAL.Models.User", b =>
                {
                    b.HasOne("MielsJimmyScrumProjectDAL.Models.Board", null)
                        .WithMany("Users")
                        .HasForeignKey("BoardId");
